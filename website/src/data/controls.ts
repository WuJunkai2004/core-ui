...
export const controls: ControlInfo[] = [
  ...
  { name: "Expander", nameKey: "ctrl.Expander.name", descKey: "ctrl.Expander.desc", category: "container", cApiCreate: "<expander>", keyFeatures: ["expand/collapse animation", "header + content"] },
  ...
  { name: "NumberBox", nameKey: "ctrl.NumberBox.name", descKey: "ctrl.NumberBox.desc", category: "input", cApiCreate: "<input type=number>", keyFeatures: ["min/max/step", "decimal places", "buttons"] },
  ...
  { name: "Dialog", nameKey: "ctrl.Dialog.name", descKey: "ctrl.Dialog.desc", category: "navigation", cApiCreate: "ui_msgbox()", keyFeatures: ["custom buttons", "modal", "keyboard shortcuts"] },
  ...
  { name: "ContextMenu", nameKey: "ctrl.ContextMenu.name", descKey: "ctrl.ContextMenu.desc", category: "navigation", cApiCreate: "<menu>", keyFeatures: ["items + shortcuts", "submenus", "separators"] },
];
